    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        <div className="footer-content-column">
          ...
          <div className="footer-menu">
            <h5 className="footer-menu-name">PORTFOLIO</h5>
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h5 className="footer-menu-name">APPROACH</h5>
            <ul id="menu-company" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">Incubation</a>
              </li>
              ...
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">Unconvention</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">Mentoring & Technical Assistance</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">Incubating Incubators</a>
              </li>
            </ul>
          </div>
          <div className="footer-menu">
            ...
            <ul id="menu-quick-links" className="footer-menu-list">
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="#">Creating Impact & Business Value of Impact</a>
              </li>
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="#">Diversity & Inclusion</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">Impact Numbers</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-menu">
            ...
            <ul id="menu-quick-links" className="footer-menu-list">
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="#">Focus Sectors</a>
              </li>
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="#">Current Programs</a>
              </li>
            </ul>
          </div>
          <div className="footer-menu">
            <h5 className="footer-menu-name">RESOURCES</h5>
            <ul id="menu-company" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">VITALS</a>
              </li>
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h5 className="footer-menu-name"> Quick Links</h5>
            <ul id="menu-quick-links" className="footer-menu-list">
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2020. | MAANOF | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
