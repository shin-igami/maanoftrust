  ...
  return (
    ...
    <div className="page-footer">
      ...
      <footer className="footer">
        <svg className="footer-wave-style" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 100" preserveAspectRatio="none">
          <path className="footer-wave-path" d="M851.8,100c125,0,288.3-45,348.2-64V0H0v44c3.7-1,7.3-1.9,11-2.9C80.7,22,151.7,10.8,223.5,6.3C276.7,2.9,330,4,383,9.8 c52.2,5.7,103.3,16.2,153.4,32.8C623.9,71.3,726.8,100,851.8,100z"></path>
        </svg>
        <div className="footer-content">
          <div className="footer-content-column">
            <div className="footer-logo">
              <Link className="link footer-logo-link"  to="/">
                <span className="hidden-link-text">LOGO</span>
                <img src={Logo} alt="" />
              </Link>
            </div>
            <div className="footer-menu">
              <h5 className="footer-menu-name">ABOUT</h5>
              <ul id="menu-get-started" className="footer-menu-list">
                <li className="menu-item menu-item-type-post_type menu-item-object-product">
                  <Link className="link" to="/about-maanof">About MAANOF</Link>
                </li>
                <li className="menu-item menu-item-type-post_type menu-item-object-product">
                  <Link className="link" to="/team">Team</Link>
                </li>
                {/* <li className="menu-item menu-item-type-post_type menu-item-object-product">
                  <Link className="link" to="">Mentors</Link>
                </li> */}
              </ul>
            </div>
          </div>
          <div className="footer-content-column">
            <div className="footer-menu">
              <h5 className="footer-menu-name">OUR IMPACT</h5>
              <ul id="menu-quick-links" className="footer-menu-list">
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <Link className="link" rel="noopener noreferrer" to="/impact/creating-impact">Creating Impact </Link>
                </li>
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <Link className="link"  rel="noopener noreferrer" to="/impact/Diversity">Diversity & Inclusion</Link>
                </li>
              </ul>
            </div>
            <div className="footer-menu">
              <h5 className="footer-menu-name">PROGRAMS</h5>
              <ul id="menu-quick-links" className="footer-menu-list">
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <Link className="link" rel="noopener noreferrer" to="/programs/focus-sectors">Focus Sectors</Link>
                </li>
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <Link className="link" rel="noopener noreferrer" to="/programs/current-programs">Current Programs</Link>
                </li>
              </ul>
            </div>
          </div>
          <div className="footer-content-column">
            <div className="footer-menu">
              <h5 className="footer-menu-name"> Contact Us</h5>
              <ul id="menu-quick-links" className="footer-menu-list">
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
          ...
          <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
            ...
            <a className="footer-social-link linkedin" href="https://twitter.com/MAANOF22" target="_blank">
              <span className="hidden-link-text">Twitter</span>
              <i className="fa-brands fa-twitter" id="footer-twitter">
            ...
            <a className="footer-social-link twitter" href="https://www.facebook.com/profile.php?id=100088649441827" target="_blank">
              <span className="hidden-link-text">Facebook</span>
              <i className="fa-brands fa-facebook-f" id="footer-facebook">
            ...
            <a className="footer-social-link youtube" href="https://www.instagram.com/maanoffederation/" target="_blank">
              <span className="hidden-link-text">Instagram</span>
              <i className="fa-brands fa-instagram" id="footer-insta">
            ...
            <a className="footer-social-link github" href="https://www.youtube.com/channel/UC25RXBGG9Qp22sLnO6jS5ug" target="_blank">
              <span className="hidden-link-text">Youtube</span>
              <i className="fa-brands fa-youtube" id="footer-youtube">
